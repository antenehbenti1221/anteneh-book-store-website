(function(){
  ...
  style.textContent=`
    ...
    @media(max-width:900px){#grid,#freeGrid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:12px!important}#grid .book .title,#freeGrid .book .title{font-size:15px!important;padding:12px!important;min-height:54px!important}}
    @media(max-width:520px){#grid,#freeGrid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:10px!important}#grid .book,#freeGrid .book{border-radius:14px!important}#grid .book .title,#freeGrid .book .title{font-size:14px!important;padding:11px 10px!important;min-height:52px!important}#grid .book .book-preview,#freeGrid .book .book-preview{padding:11px!important}#grid .book .bottom{padding:0 10px 10px!important}#grid .book .bottom .btn{min-width:100px!important;font-size:13px!important}#freeGrid .book .book-preview .book-view-button{min-width:100px!important;font-size:13px!important}}
  `;
